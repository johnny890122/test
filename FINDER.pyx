...
#################################################New code for FINDER#####################################
    ...
    def Evaluate(self, data_test, model_file=None):
        ...
        self.InsertGraph(g, is_test=True)
        t1 = time.time()
        val, sol, solution = self.GetSol(0)
    ...
    def GetSol(self, int gid, int step=1):
        ...
        # # 記得拿掉
        # for i in range(g_list[0].num_nodes):
        #     sol = []
        #     solution = list(set(nodes)^set(sol))
        #     Robustness = self.utils.getRobustness(g_list[0], solution)
        #     print("solution", solution)
        #     print("sol", sol)
        #     print("Robustness", Robustness*(g_list[0].num_nodes)*(g_list[0].num_nodes))
        #     print("="*10)
        ...
        return Robustness, sol, solution
